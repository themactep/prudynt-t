...
static constexpr char kBackchannelRequireTag[] = "www.onvif.org/ver20/backchannel";
static constexpr char kBackchannelRequireEnvVar[] = "PRUDYNT_RTSP_DESCRIBE_REQUIRE_BACKCHANNEL";

PrudyntRTSPServer *PrudyntRTSPServer::createNew(UsageEnvironment &env, Port ourPort,
...
bool PrudyntRTSPServer::PrudyntRTSPClientConnection::requestHasBackchannelRequire(
  ...
  size_t searchPos = 0;
  while ((searchPos = lowered.find("require:", searchPos)) != std::string::npos) {
...
void PrudyntRTSPServer::PrudyntRTSPClientConnection::handleCmd_DESCRIBE_afterLookup(
