...
std::vector<ConfigItem<bool>> CFG::getBoolItems() {
  return {
      ...
      {"stream0.osd.logo_enabled", stream0.osd.logo_enabled, true,
       validateBool},
      {"stream0.osd.time_enabled", stream0.osd.time_enabled, true,
       validateBool},
      {"stream0.osd.uptime_enabled", stream0.osd.uptime_enabled, true,
       validateBool},
      {"stream0.osd.user_text_enabled", stream0.osd.user_text_enabled, true,
       validateBool},
#if defined(AUDIO_SUPPORT)
      ...
      {"stream1.osd.logo_enabled", stream1.osd.logo_enabled, true,
       validateBool},
      {"stream1.osd.time_enabled", stream1.osd.time_enabled, true,
       validateBool},
      {"stream1.osd.uptime_enabled", stream1.osd.uptime_enabled, true,
       validateBool},
      {"stream1.osd.user_text_enabled", stream1.osd.user_text_enabled, true,
       validateBool},
...
std::vector<ConfigItem<const char *>> CFG::getCharItems() {
  return {
      ...
      {"stream0.osd.user_text_format", stream0.osd.user_text_format,
       "%hostname", validateCharNotEmpty},
      ...
      {"stream1.osd.uptime_format", stream1.osd.uptime_format,
       "Up: %02lud %02lu:%02lu", validateCharNotEmpty},
      {"stream1.osd.user_text_format", stream1.osd.user_text_format,
       "%hostname", validateCharNotEmpty},
...
std::vector<ConfigItem<int>> CFG::getIntItems() {
  return {
      ...
      {"stream0.osd.font_xscale", stream0.osd.font_xscale, 100,
       validateInt50_150},
      {"stream0.osd.font_yscale", stream0.osd.font_yscale, 100,
       validateInt50_150},
      ...
      {"stream0.osd.logo_rotation", stream0.osd.logo_rotation, 0,
       validateInt360},
      {"stream0.osd.logo_transparency", stream0.osd.logo_transparency, 255,
       validateInt255},
      {"stream0.osd.logo_width", stream0.osd.logo_width, 100, validateIntGe0},
      {"stream0.osd.pos_logo_x", stream0.osd.pos_logo_x, OSD_AUTO_VALUE,
       validateInt15360},
      {"stream0.osd.pos_logo_y", stream0.osd.pos_logo_y, OSD_AUTO_VALUE,
       validateInt15360},
      {"stream0.osd.pos_time_x", stream0.osd.pos_time_x, OSD_AUTO_VALUE,
       validateInt15360},
      {"stream0.osd.pos_time_y", stream0.osd.pos_time_y, OSD_AUTO_VALUE,
       validateInt15360},
      {"stream0.osd.pos_uptime_x", stream0.osd.pos_uptime_x, OSD_AUTO_VALUE,
       validateInt15360},
      {"stream0.osd.pos_uptime_y", stream0.osd.pos_uptime_y, OSD_AUTO_VALUE,
       validateInt15360},
      {"stream0.osd.pos_user_text_x", stream0.osd.pos_user_text_x,
       OSD_AUTO_VALUE, validateInt15360},
      {"stream0.osd.pos_user_text_y", stream0.osd.pos_user_text_y,
       OSD_AUTO_VALUE, validateInt15360},
      {"stream0.osd.start_delay", stream0.osd.start_delay, 0,
       [](const int &v) { return v >= 0 && v <= 5000; }},
      {"stream0.osd.time_rotation", stream0.osd.time_rotation, 0,
       validateInt360},
      {"stream0.osd.uptime_rotation", stream0.osd.uptime_rotation, 0,
       validateInt360},
      {"stream0.osd.user_text_rotation", stream0.osd.user_text_rotation, 0,
       validateInt360},
      ...
      {"stream1.osd.font_xscale", stream1.osd.font_xscale, 100,
       validateInt50_150},
      {"stream1.osd.font_yscale", stream1.osd.font_yscale, 100,
       validateInt50_150},
      ...
      {"stream1.osd.logo_rotation", stream1.osd.logo_rotation, 0,
       validateInt360},
      {"stream1.osd.logo_transparency", stream1.osd.logo_transparency, 255,
       validateInt255},
      {"stream1.osd.logo_width", stream1.osd.logo_width, 100, validateIntGe0},
      {"stream1.osd.pos_logo_x", stream1.osd.pos_logo_x, OSD_AUTO_VALUE,
       validateInt15360},
      {"stream1.osd.pos_logo_y", stream1.osd.pos_logo_y, OSD_AUTO_VALUE,
       validateInt15360},
      {"stream1.osd.pos_time_x", stream1.osd.pos_time_x, OSD_AUTO_VALUE,
       validateInt15360},
      {"stream1.osd.pos_time_y", stream1.osd.pos_time_y, OSD_AUTO_VALUE,
       validateInt15360},
      {"stream1.osd.pos_uptime_x", stream1.osd.pos_uptime_x, OSD_AUTO_VALUE,
       validateInt15360},
      {"stream1.osd.pos_uptime_y", stream1.osd.pos_uptime_y, OSD_AUTO_VALUE,
       validateInt15360},
      {"stream1.osd.pos_user_text_x", stream1.osd.pos_user_text_x,
       OSD_AUTO_VALUE, validateInt15360},
      {"stream1.osd.pos_user_text_y", stream1.osd.pos_user_text_y,
       OSD_AUTO_VALUE, validateInt15360},
      {"stream1.osd.start_delay", stream1.osd.start_delay, 0,
       [](const int &v) { return v >= 0 && v <= 5000; }},
      {"stream1.osd.time_rotation", stream1.osd.time_rotation, 0,
       validateInt360},
      {"stream1.osd.uptime_rotation", stream1.osd.uptime_rotation, 0,
       validateInt360},
      {"stream1.osd.user_text_rotation", stream1.osd.user_text_rotation, 0,
       validateInt360},
...
std::vector<ConfigItem<unsigned int>> CFG::getUintItems() {
  return {
      ...
      {"stream0.osd.time_font_color", stream0.osd.time_font_color, 0xFFFFFFFF,
       validateOSDColor},
      {"stream0.osd.time_font_stroke_color", stream0.osd.time_font_stroke_color,
       0xFF000000, validateOSDColor},
      {"stream0.osd.uptime_font_color", stream0.osd.uptime_font_color,
       0xFFFFFFFF, validateOSDColor},
      {"stream0.osd.uptime_font_stroke_color",
       stream0.osd.uptime_font_stroke_color, 0xFF000000, validateOSDColor},
      {"stream0.osd.user_text_font_color", stream0.osd.user_text_font_color,
       0xFFFFFFFF, validateOSDColor},
      {"stream0.osd.user_text_font_stroke_color",
       stream0.osd.user_text_font_stroke_color, 0xFF000000, validateOSDColor},
      // Individual color settings for stream1 text elements
      {"stream1.osd.time_font_color", stream1.osd.time_font_color, 0xFFFFFFFF,
       validateOSDColor},
      {"stream1.osd.time_font_stroke_color", stream1.osd.time_font_stroke_color,
       0xFF000000, validateOSDColor},
      {"stream1.osd.uptime_font_color", stream1.osd.uptime_font_color,
       0xFFFFFFFF, validateOSDColor},
      {"stream1.osd.uptime_font_stroke_color",
       stream1.osd.uptime_font_stroke_color, 0xFF000000, validateOSDColor},
      {"stream1.osd.user_text_font_color", stream1.osd.user_text_font_color,
       0xFFFFFFFF, validateOSDColor},
      {"stream1.osd.user_text_font_stroke_color",
       stream1.osd.user_text_font_stroke_color, 0xFF000000, validateOSDColor},
  };
};
...
void handleConfigItem(json_object *jsonConfig, ConfigItem<T> &item) {
  ...
  if (!readFromProc) {
    ...
    for (size_t i = 0; i < pathParts.size() - 1; ++i) {
      ...
      if (json_object_object_get_ex(currentJson, pathParts[i].c_str(),
                                    &nextObj)) {
...
bool CFG::updateConfig() {
  ...
  // Write JSON to file
  const char *jsonString = json_object_to_json_string_ext(
      jsonConfig, JSON_C_TO_STRING_PRETTY | JSON_C_TO_STRING_NOSLASHESCAPE);
  if (jsonString) {
...
void CFG::migrateOldColorSettings() {
  ...
  // Creates ARGB format for internal use (matches OSD::drawText() bit
  // extraction)
  auto combineColorWithAlpha = [](unsigned int rgb_color,
                                  int transparency) -> unsigned int {
  ...
  if (json_object_object_get_ex(jsonConfig, "stream0", &stream0Obj)) {
    ...
    if (json_object_object_get_ex(stream0Obj, "osd", &osdObj)) {
      ...
      bool hasOldFormat =
          json_object_object_get_ex(osdObj, "font_color", &fontColorObj) &&
          json_object_object_get_ex(osdObj, "font_stroke_color",
                                    &fontStrokeColorObj) &&
          (json_object_object_get_ex(osdObj, "time_transparency",
                                     &timeTransparencyObj) ||
           json_object_object_get_ex(osdObj, "uptime_transparency",
                                     &uptimeTransparencyObj) ||
           json_object_object_get_ex(osdObj, "user_text_transparency",
                                     &userTextTransparencyObj));
      ...
      if (hasOldFormat) {
        ...
        if (timeTransparencyObj &&
            json_object_is_type(timeTransparencyObj, json_type_int)) {
          timeTransparency = json_object_get_int(timeTransparencyObj);
        }
        if (uptimeTransparencyObj &&
            json_object_is_type(uptimeTransparencyObj, json_type_int)) {
          uptimeTransparency = json_object_get_int(uptimeTransparencyObj);
        }
        if (userTextTransparencyObj &&
            json_object_is_type(userTextTransparencyObj, json_type_int)) {
    ...
    if (json_object_object_get_ex(jsonConfig, "rois", &roisObj) &&
      ...
      for (int i = 0; i < motion.roi_count; i++) {
        ...
        if (json_object_object_get_ex(roisObj, roiKey.c_str(), &roiArray) &&
          ...
          if (arrayLen == 4) {
            motion.rois[i].p0_x =
                json_object_get_int(json_object_array_get_idx(roiArray, 0));
            motion.rois[i].p0_y =
                json_object_get_int(json_object_array_get_idx(roiArray, 1));
            motion.rois[i].p1_x =
                json_object_get_int(json_object_array_get_idx(roiArray, 2));
            motion.rois[i].p1_y =
                json_object_get_int(json_object_array_get_idx(roiArray, 3));
          }
        }
      }
    }
