...
std::vector<ConfigItem<bool>> CFG::getBoolItems() {
  return {
      ...
      {"stream0.osd.logo_enabled", stream0.osd.logo_enabled, true,
       validateBool},
      {"stream0.osd.brightness_enabled", stream0.osd.brightness_enabled, false,
       validateBool},
      ...
      {"stream1.osd.logo_enabled", stream1.osd.logo_enabled, true,
       validateBool},
      {"stream1.osd.brightness_enabled", stream1.osd.brightness_enabled, false,
       validateBool},
      {"stream1.osd.time_enabled", stream1.osd.time_enabled, true,
       validateBool},
      {"stream1.osd.uptime_enabled", stream1.osd.uptime_enabled, true,
       validateBool},
      {"stream1.osd.usertext_enabled", stream1.osd.usertext_enabled, true,
       validateBool},
...
std::vector<ConfigItem<const char *>> CFG::getCharItems() {
  return {
      ...
      {"stream0.osd.usertext_format", stream0.osd.usertext_format, "%hostname",
       validateCharNotEmpty},
      {"stream0.osd.time_position", stream0.osd.time_position, "10,10",
       validateCharNotEmpty},
      {"stream0.osd.uptime_position", stream0.osd.uptime_position, "1600,5",
       validateCharNotEmpty},
      {"stream0.osd.usertext_position", stream0.osd.usertext_position, "900,5",
       validateCharNotEmpty},
      {"stream0.osd.logo_position", stream0.osd.logo_position, "1800,1030",
       validateCharNotEmpty},
      {"stream0.osd.brightness_position", stream0.osd.brightness_position,
       "10,70", validateCharNotEmpty},
      {"stream0.osd.brightness_format", stream0.osd.brightness_format,
      ...
      {"stream1.osd.uptime_format", stream1.osd.uptime_format,
       "Up: %02lud %02lu:%02lu", validateCharNotEmpty},
      {"stream1.osd.usertext_format", stream1.osd.usertext_format, "%hostname",
       validateCharNotEmpty},
      {"stream1.osd.time_position", stream1.osd.time_position, "10,10",
       validateCharNotEmpty},
      {"stream1.osd.uptime_position", stream1.osd.uptime_position, "500,5",
       validateCharNotEmpty},
      {"stream1.osd.usertext_position", stream1.osd.usertext_position, "250,5",
       validateCharNotEmpty},
      {"stream1.osd.logo_position", stream1.osd.logo_position, "530,320",
       validateCharNotEmpty},
      {"stream1.osd.brightness_position", stream1.osd.brightness_position,
       "10,70", validateCharNotEmpty},
      {"stream1.osd.brightness_format", stream1.osd.brightness_format,
       "Gain: %b%% Avg: %a%% %m", validateCharNotEmpty},
...
std::vector<ConfigItem<int>> CFG::getIntItems() {
  return {
      ...
      {"stream0.osd.uptime_rotation", stream0.osd.uptime_rotation, 0,
       validateInt360},
      {"stream0.osd.usertext_rotation", stream0.osd.usertext_rotation, 0,
       validateInt360},
      {"stream0.osd.brightness_rotation", stream0.osd.brightness_rotation, 0,
       validateInt360},
      ...
      {"stream1.osd.uptime_rotation", stream1.osd.uptime_rotation, 0,
       validateInt360},
      {"stream1.osd.usertext_rotation", stream1.osd.usertext_rotation, 0,
       validateInt360},
      {"stream1.osd.brightness_rotation", stream1.osd.brightness_rotation, 0,
       validateInt360},
...
std::vector<ConfigItem<unsigned int>> CFG::getUintItems() {
  return {
      ...
      {"stream0.osd.usertext_font_color", stream0.osd.usertext_font_color,
       0xFFFFFFFF, validateOSDColor},
      {"stream0.osd.usertext_font_stroke_color",
       stream0.osd.usertext_font_stroke_color, 0xFF000000, validateOSDColor},
      {"stream0.osd.brightness_font_color", stream0.osd.brightness_font_color,
       0xFFFFFFFF, validateOSDColor},
      {"stream0.osd.brightness_font_stroke_color",
      ...
      {"stream1.osd.usertext_font_color", stream1.osd.usertext_font_color,
       0xFFFFFFFF, validateOSDColor},
      {"stream1.osd.usertext_font_stroke_color",
       stream1.osd.usertext_font_stroke_color, 0xFF000000, validateOSDColor},
      {"stream1.osd.brightness_font_color", stream1.osd.brightness_font_color,
       0xFFFFFFFF, validateOSDColor},
      {"stream1.osd.brightness_font_stroke_color",
