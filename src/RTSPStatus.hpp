 ...
 *
 * Provides access to active RTSP stream parameters through a file-based
 * interface similar to /proc filesystem pattern. This enables shell scripts and
 * external tools to query current streaming configuration without parsing JSON
 * files or interacting with the application directly.
 *
 ...
 * - /run/prudynt/rtsp/stream0/url         (e.g.,
 * "rtsp://192.168.1.100:554/ch0")
...
public:
  ...
  // Write a custom parameter file under a given stream directory (e.g.,
  // "audio0")
