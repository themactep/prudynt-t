...
int IMPSystem::init() {
  ...
  LOG_DEBUG("IMPSystem init: entering hal::isp::set_max_dgain("
            << cfg->image.max_dgain << ")");
  ret =
  ...
  LOG_DEBUG("IMPSystem init: entering hal::isp::set_wb(mode="
  ...
  LOG_DEBUG("IMPSystem init: entering hal::isp::set_defog_strength("
  ...
  LOG_DEBUG("IMPSystem init: entering hal::isp::set_dpc_strength("
  ...
  LOG_DEBUG("IMPSystem init: entering hal::isp::set_drc_strength("
  ...
  if (backlight_requested) {
    LOG_DEBUG("IMPSystem init: entering hal::isp::set_backlight_comp("
  ...
  if ((!applied_backlight || !hal::caps().has_isp_backlight_comp) &&
      highlight_requested) {
    LOG_DEBUG("IMPSystem init: entering hal::isp::set_highlight_depress("
