 ...
 *
 * Provides access to sensor information directly via /proc/jz/sensor/ filesystem.
 * This ensures dynamic sensor detection without requiring static JSON
 * configuration files, providing a single source of truth for sensor data
