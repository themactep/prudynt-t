...
public:
  static BackchannelServerMediaSubsession *
  createNew(UsageEnvironment &env, IMPBackchannelFormat format);

  void setRequireTag(char const *tag) {
    fRequireTag = tag;
  }
...
private:
  bool allocateUdpPorts(Port &serverRTPPort, Port &serverRTCPPort,
